...
@time T_sol1 = time_temperature(T_0,A,rhs,(0.0,t_end1),T_bc_bott,T_bc_top,0.01,10)
@time T_sol2 = time_temperature(T_0,A,rhs,(0.0,t_end2),T_bc_bott,T_bc_top,0.1,1)
@time T_sol3 = time_temperature(T_0,A,rhs,(0.0,t_end3),T_bc_bott,T_bc_top,1,0.1)
...
lines!(ax,timestamps1,log.(10,T_errors_1),label = L"\lambda = 0.01")
lines!(ax,timestamps2,log.(10,T_errors_2),label = L"\lambda = 0.1")
lines!(ax,timestamps3,log.(10,T_errors_3),label = L"\lambda = 1")
axislegend()
